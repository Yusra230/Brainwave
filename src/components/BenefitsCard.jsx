...
const BenefitsCard = ({ item }) => {
    return <>
        <div class="col position-relative main-card">
            <div class={`card h-100 gradient-border benefit-card 
            ...
            `}>
                {/* <img src="image-2.png" class="card-img" alt="..."></img> */}
                <div class="card-body text-start benefit-card-body">
                    <h5 class="card-title text-white mb-4">{item.title}</h5>
            ...
            <div class="col position-absolute benefit-card-img ">
                <img src="image-2.png" class="card-img benefit-img" alt="..."></img>
            </div>
        </div>
