...
const RoadMapSection = () => {
    ...
    return <>
        ...
        <div className="service mb-4">
            <div className="col-xl-12 col-xxl-11">
                <div className="row align-items-center g-lg-4">
                    <div className="col-lg-6 text-center text-lg-start mt-0">
                        <RoadMapCard1 roadMapObj={roadMapObj[0]}></RoadMapCard1>
                    </div>

                    <div className="col-lg-6 coll-img text-center text-lg-start roadmap-card-margin">
        ...
        <div className="service">
            <div className="col-xl-12 col-xxl-11">
                <div className="row align-items-center g-lg-4">
                    <div className="col-lg-6 text-center text-lg-start roadmap-card-margn-2">
                        <RoadMapCard1 roadMapObj={roadMapObj[2]}></RoadMapCard1>
                    </div>

                    <div className="col-lg-6 coll-img text-center text-lg-start">
