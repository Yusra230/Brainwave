...
const ServicesSection = () => {
    ...
    return <>
        <center id="howToUse" className="service mb-4">
            <h1 class="main-heading mb-4 coll-heading">Generative AI made for creators.</h1>
            <p className="coll-para mob-text-start ">Brainwave unlocks the potential of AI-powered applications</p>

            <div class="col-xl-12 col-xxl-11 services-container">
                <div class="row align-items-center g-lg-5">
                    <div class="col-lg-8 text-center text-lg-start">
                        <img src="service-1.png" class="d-block mx-lg-auto img-fluid service-img" alt="AI image" loading="lazy"></img>
                    </div>

                    <div class="col-lg-4 coll-img text-center text-lg-start">
                        <h2 class="display-6 mb-5 coll-heading mob-margin">Smartest AI</h2>
                ...
                <div className="container askinput ai-input">
                    ...
                    <input class="form-control disabled-input text-white" type="text" value="AI is generating" aria-label="Disabled input example" disabled readonly />
                </div>
            </div>
        </center>
        ...
        <div className="service">
            <div class="col-xl-12 col-xxl-11">
                <div class="row align-items-center g-lg-4">
                    ...
                    <div class="col-lg-6 coll-img text-lg-start">
                        <ServiceCard2 />
                    </div>
                </div>
            </div>
